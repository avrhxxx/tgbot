...
# OPTION A architecture (central routing registry).
# =========================================
...
# =========================================================
# 🔥 CENTRAL ROUTING REGISTRY (OPTION A)
# IMPORTANT: this must be imported ONCE for side effects
# =========================================================
...
def create_dispatcher() -> Dispatcher:
    ...
    logger.info("Dispatcher ready (OPTION A routing enabled)")
